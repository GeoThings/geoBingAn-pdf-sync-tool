...
| 項目 | 狀態 | 數量 |
|---------|------|--------|
| 建案監測 | ✅ 已同步 | 292 個建案，新增 67 個 PDF |
| Google Drive PDF | ✅ 掃描完成 | 26,820 個（含子資料夾遞迴掃描） |
| 農曆新年後上傳 | ✅ 完成 | 100 個 PDF 上傳至究平安 |
| 究平安報告對應 | ✅ 成功 | 15,002 筆對應（名稱模糊匹配） |
| 建案名稱覆蓋 | ✅ 92% | 378/411 筆（API 優先 + 6 來源交叉比對） |
| API Project 匹配 | ✅ 116 筆 | 580 個 construction-projects 滑動視窗匹配 |
| 即時警戒值 | ✅ 66 筆 | 從 construction-alerts API 即時取得 |
| JWT 自動刷新 | ✅ 正常 | Token 過期自動更新 |
| 執行時間 | ⚡ ~10 分鐘 | 同步 5m + 名稱比對 1m + 報告 4m |
